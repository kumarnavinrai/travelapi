...
class BargainFinderMaxSoapActivity implements Activity {
    ...
    public function run(&$sharedContext) {
      ...
      if(isset($_REQUEST['origin']) && $_REQUEST['origin'] != "")
      {
        ...
        $soapClient = new SACSSoapClient("BargainFinderMax_ADRQ");
        ...
        $sharedContext->addResult("BargainFinderMax_ADRQ", $xmlRequest);
        $sharedContext->addResult("BargainFinderMax_ADRS", $soapClient->doCall($sharedContext, $xmlRequest));
        return null;
