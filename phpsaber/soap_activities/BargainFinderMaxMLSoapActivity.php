...
class BargainFinderMaxMLSoapActivity implements Activity {
    ...
    public function run(&$sharedContext) {
      ...
      if(isset($_REQUEST['origin1']) && $_REQUEST['origin1'] != "")
      {
          ...
          $origin1 = $_REQUEST['origin1']; //filter_input($_REQUEST['origin']);
          $destination1 = $_REQUEST['destination1']; //filter_input($_REQUEST['destination']);
          $departureDate1 = $_REQUEST['startml1']; //filter_input($_REQUEST['departureDate']);

          $origin2 = $_REQUEST['origin2']; //filter_input($_REQUEST['origin']);
          $destination2 = $_REQUEST['destination2']; //filter_input($_REQUEST['destination']);
          $departureDate2= $_REQUEST['startml2']; //filter_input($_REQUEST['departureDate']);

          $origin3 = $_REQUEST['origin3']; //filter_input($_REQUEST['origin']);
          $destination3 = $_REQUEST['destination3']; //filter_input($_REQUEST['destination']);
          $departureDate3= $_REQUEST['startml3']; //filter_input($_REQUEST['departureDate']);

          $origin4 = $_REQUEST['origin4']; //filter_input($_REQUEST['origin']);
          $destination4 = $_REQUEST['destination4']; //filter_input($_REQUEST['destination']);
          $departureDate4= $_REQUEST['startml4']; //filter_input($_REQUEST['departureDate']);

          $origin5 = $_REQUEST['origin5']; //filter_input($_REQUEST['origin']);
          $destination5 = $_REQUEST['destination5']; //filter_input($_REQUEST['destination']);
          $departureDate5= $_REQUEST['startml5']; //filter_input($_REQUEST['departureDate']);
