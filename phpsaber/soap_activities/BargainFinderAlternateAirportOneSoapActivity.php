...
class BargainFinderMaxSoapActivity implements Activity {
    ...
    public function run(&$sharedContext) {
      ...
      if(isset($_REQUEST['origin']) && $_REQUEST['origin'] != "")
      {
        ...
        $soapClient = new SACSSoapClient("BargainFinderMax_ASRQ");
        ...
        $sharedContext->addResult("BargainFinderMax_ASRQ", $xmlRequest);
        $sharedContext->addResult("BargainFinderMax_ASRS", $soapClient->doCall($sharedContext, $xmlRequest));
        return null;
...
$rtn = '<OTA_AirLowFareSearchRQ xmlns="http://www.opentravel.org/OTA/2003/05" Version="1.9.2" ResponseType="OTA" ResponseVersion="1.9.2">
  ...
  <OriginDestinationInformation RPH="1">
    <DepartureDateTime>2017-01-17T00:00:00</DepartureDateTime>
      ...
      {  
        $onewayxml = '<OTA_AirLowFareSearchRQ Version="1.9.2"  xmlns="http://www.opentravel.org/OTA/2003/05">';
          ...
          $onewayxml .= '<TPA_Extensions>';
            $onewayxml .= '<IntelliSellTransaction><RequestType Name="AD3" /></IntelliSellTransaction>';
          $onewayxml .= '</TPA_Extensions>';
