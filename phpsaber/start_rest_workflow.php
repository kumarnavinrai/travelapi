...
$domainarray[] = 'https://flightsgogo.com';
...
include_once 'soap_activities/BargainFinderMaxMLSoapActivity.php';
...
function takeOutAirportCode($data)
{
  ...
  return $fromairportcode;
      ...
      if(isset($_REQUEST['origin1']) && $_REQUEST['origin1'])
      {
          $_REQUEST['origin1'] = takeOutAirportCode($_REQUEST['origin1']);       
          $_REQUEST['destination1'] = takeOutAirportCode($_REQUEST['destination1']);       
          
      }
      if(isset($_REQUEST['origin2']) && $_REQUEST['origin2'])
      {
          $_REQUEST['origin2'] = takeOutAirportCode($_REQUEST['origin2']);       
          $_REQUEST['destination2'] = takeOutAirportCode($_REQUEST['destination2']);       
           
      }
      if(isset($_REQUEST['origin3']) && $_REQUEST['origin3'])
      {
          $_REQUEST['origin3'] = takeOutAirportCode($_REQUEST['origin3']);       
          $_REQUEST['destination3'] = takeOutAirportCode($_REQUEST['destination3']);       
               
      }
      if(isset($_REQUEST['origin4']) && $_REQUEST['origin4'])
      {
          $_REQUEST['origin4'] = takeOutAirportCode($_REQUEST['origin4']);       
          $_REQUEST['destination4'] = takeOutAirportCode($_REQUEST['destination4']);       
             
      }
      if(isset($_REQUEST['origin5']) && $_REQUEST['origin5'])
      {
          $_REQUEST['origin5'] = takeOutAirportCode($_REQUEST['origin5']);       
          $_REQUEST['destination5'] = takeOutAirportCode($_REQUEST['destination5']);       
         
      }


      
    	$outboundstopduration = 0;
    	$inboundstopduration = 0;
    	if(isset($_REQUEST['inboundstopduration']) && $_REQUEST['inboundstopduration'] != "")
      {
    		$outboundstopduration = $_REQUEST['inboundstopduration'];
    		$inboundstopduration = $_REQUEST['inboundstopduration'];
    	}
    	...
    	if(isset($_REQUEST['origin']) && $_REQUEST['origin'] != "")
      {
          ...
          $inboundstopduration = filter_input(INPUT_POST, "inboundstopduration"); //filter_input($inboundstopduration);
    			...
    			$passengercount = 1;//filter_input(INPUT_POST, "passengercount"); //filter_input($_REQUEST['passengercount']);
    			$lengthofstay = filter_input(INPUT_POST, "lengthofstay"); //filter_input($_REQUEST['lengthofstay']);
          $sortingvalue = filter_input(INPUT_POST, "sortbyval");
          ...
          $travel_class = filter_input(INPUT_POST, "travel_class");
    			...
    			$workflow = new Workflow(new LeadPriceCalendarActivity($origin, $destination, $departureDate, $returndate, $limit, $outboundflightstops, $outbounddeparturewindow, $includedcarriers, $inboundstopduration, $outboundstopduration, $passengercount, $lengthofstay));
      ...
      if(isset($_REQUEST['origin1']) && $_REQUEST['origin1'] != "")
      {
        ...
        //amadeus data creation starts here  
		      ...
		      $paramsforamadeus['apikey'] = 'DKrstcxEEcNAUFhX9gkVQFS3dIYH1qY5';
          
		      $paramsforamadeus['nonstop'] = $nonstop;
		      if(isset($outboundflightstops) && $outboundflightstops != "" && $outboundflightstops == 0)
          {
            $nonstop = 'true';
            $paramsforamadeus['nonstop'] = $nonstop;
          }
          ...
          if(isset($outbounddeparturewindow) && $outbounddeparturewindow != "")
          {
            ...
            //console.log(output);
            $arrivebyval = $departuredate ."T". $time;
          }
          ...
          if(isset($outbounddeparturewindow) && $outbounddeparturewindow != "")
          {
            ...
            $time = substr($time,0,2).':'.substr($time,2,2);
            //console.log(output);
            $returnbyval = $departuredate ."T". $time; 
          }
          ...
          {
            $urlamadeus = "origin=".$origin."&destination=".$destination."&departure_date=".$departureDate;
          

            $paramsforamadeus['origin'] = $origin;
            $paramsforamadeus['destination'] = $destination;
            $paramsforamadeus['departure_date'] = $departureDate;
          }

          if(isset($returndate) && $returndate != "")
          {
            $urlamadeus = $urlamadeus ."&return_date=".$returndate;
            $paramsforamadeus['return_date'] = $returndate;

          }

          if(isset($limit) && $limit != "")
          {
            $urlamadeus = $urlamadeus ."&number_of_results=".$limit;
            $paramsforamadeus['number_of_results'] = 100;//$limit;
          }

          if(isset($nonstop) && $nonstop != "")
          {
            $urlamadeus = $urlamadeus ."&nonstop=".$nonstop;
            $paramsforamadeus['nonstop'] = $nonstop;
          }

          if(isset($arrivebyval) && $arrivebyval != "")
          {
            $urlamadeus = $urlamadeus ."&arrive_by=".$arrivebyval;
            $paramsforamadeus['arrive_by'] = $arrivebyval;
          }

          if(isset($includedcarriers) && $includedcarriers != "")
          {
            $urlamadeus = $urlamadeus +"&include_airlines="+$includedcarriers;
            $paramsforamadeus['include_airlines'] = $includedcarriers;
          }

          if(isset($passengercount) && $passengercount != 0)
          {
            $urlamadeus = $urlamadeus ."&adults=".$passengercount;
            $paramsforamadeus['adults'] = $passengercount;
          }

          if(isset($children) && $children != 0)
          {
            $urlamadeus = $urlamadeus ."&children=".$children;
            $paramsforamadeus['children'] = $children;
          }

          if(isset($infant) && $infant != 0)
          {
            $urlamadeus = $urlamadeus ."&infants=".$infant;
            $paramsforamadeus['infants'] = $infant;
          }

          if(isset($travel_class) && $travel_class != "")
          {
            $urlamadeus = $urlamadeus ."&travel_class=".$travel_class;
            $paramsforamadeus['travel_class'] = $travel_class;
          }
          ...
          $urltosendforamadeus = "https://api.sandbox.amadeus.com/v1.2/flights/low-fare-search";

          $amadeusresult = getamadeus($urltosendforamadeus, $paramsforamadeus);
        //amadeus data creation ends here
      ...
      if(isset($amadeusresult) && $amadeusresult && $donotrunamadeus != 'yes')
      {
        ...
        if($resultsofamadeustorunloop && isset($checkitinerariescame->itineraries))
        {
          ...
          foreach ($resultsofamadeustorunloop as $keyitinerary => $value) 
          {
            ...
            $datatoaddbyamadeus[$keyitinerary]['fareall'] = $value['fare'];

            if(isset($value['fare']->price_per_infant)) 
            {
              
              $datatoaddbyamadeus[$keyitinerary]['infantfare']['fare']=$value['fare']->price_per_infant->total_fare;
              $datatoaddbyamadeus[$keyitinerary]['infantfare']['tax']=$value['fare']->price_per_infant->tax;
              //echo "<pre>"; print_r($valueptc); exit;    
            }

            if(isset($value['fare']->price_per_child)) 
            {
              
              $datatoaddbyamadeus[$keyitinerary]['childfare']['fare']=$value['fare']->price_per_child->total_fare;
              $datatoaddbyamadeus[$keyitinerary]['childfare']['tax']=$value['fare']->price_per_child->tax;
              //echo "<pre>"; print_r($valueptc); exit;    
            }
            ...
            foreach ($outbound as $keyout => $valueout) 
            {
              ...
              $datatoaddbyamadeus[$keyitinerary]['inoutflightarr'][$counterforinoutflightarray]['marketingairlinefullname'] = isset($listofairports[$valueout->marketing_airline])?$listofairports[$valueout->marketing_airline]:$valueout->marketing_airline;
              ...
              $datatoaddbyamadeus[$keyitinerary]['inoutflightarr'][$counterforinoutflightarray]['travelclass'] = str_replace("_", " ", $valueout->booking_info->travel_class);
              ...
              $datatoaddbyamadeus[$keyitinerary]['inoutflightarr'][$counterforinoutflightarray]['nameofmarketingairline'] = isset($listofairports[$valueout->marketing_airline])?$listofairports[$valueout->marketing_airline]:$valueout->marketing_airline;
      ...
      if(isset($_REQUEST['origin1']) && $_REQUEST['origin1'])
      {
        $workflow = new Workflow(new BargainFinderMaxMLSoapActivity());
        
        $resultbfmml = $workflow->runWorkflow();

      $arrayofresbfmml = (array) $resultbfmml; 

          if($arrayofresbfmml)
          {
                $datatoaddbyamadeus = array();
               
                $bypassfirstelementofarraybfmml = reset($arrayofresbfmml);
                 
                //echo "<pre>"; print_r($bypassfirstelementofarraybfm); die; 

                $requestofxmlbfmml = $bypassfirstelementofarraybfmml['BargainFinderMaxRQ'];
                
                $arraybfmrequestarrayml = XML2Array::createArray($requestofxmlbfmml);

                $responseofbfmml = $bypassfirstelementofarraybfmml['BargainFinderMaxRS'];

                $arraybfmresponsearrayml = XML2Array::createArray($responseofbfmml);
                
                $arraybfmresponsearrayml = reset($arraybfmresponsearrayml);  //[SOAP-ENV:Envelope]

                $arraybfmresponsearrayml = $arraybfmresponsearrayml['SOAP-ENV:Body'];
               
                $arraybfmresponsearrayml = reset($arraybfmresponsearrayml); // [OTA_AirLowFareSearchRS]
                
                if(isset($arraybfmresponsearrayml['PricedItineraries']))
                {  
                  $arraybfmresponsearrayml = $arraybfmresponsearrayml['PricedItineraries']; 
                  $arraybfmresponsearrayml = $arraybfmresponsearrayml['PricedItinerary']; 
                  
                  $bfmtresultsml = $arraybfmresponsearrayml;
                }else{ $bfmtresultsml = array(); }
              }  
