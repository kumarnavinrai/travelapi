          ...
          angular.forEach(urlsnew, function(url) {
            ...
            if(counter == 1){
              ...
              urlCalls.push($http({ 
                  ...
                  data: "origin="+data.origin+"&departureDate="+data.departureDate+"&returndate="+data.returndate+"&limit="+data.limit+"&rooms="+data.rooms+"&adult="+data.adult+"&children="+data.children+"&childrenhotel="+data.childrenhotel+"&amenities="+data.amenities+"&rating="+data.rating+"&price="+data.price+"&sortbyval="+data.sortbyval,                  headers: headers 
              }) 
              .success(function(data) { 
                return data;
              }) 
