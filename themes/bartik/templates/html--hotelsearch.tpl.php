...
//sortingcls cls_sortbyval
        ...
        <script type="text/javascript">
          ...
          app.controller('filghtCtrl', ['$scope', '$log', 'flightServiceNew' , 'getFlightDataService', 'getFlightBmf', 'flightServiceNewAlter', 'flightServiceNewAlterAirport', 'flightServiceNewHotel',  function($scope, $log, flightServiceNew, getFlightDataService, getFlightBmf, flightServiceNewAlter, flightServiceNewAlterAirport, flightServiceNewHotel)  { 
            <?php 
            ...
            ?>
              ...
              <?php //print_r($_POST); die; ?>
               ...
               //hotel search sterted
 /*              Array
(
    [hotelsearchcrt] => New Orleans (NEW), Louisiana, United States Of America, (Lakefront, New Orleans)
    [starth] => 2016-12-27
    [endh] => 2017-01-31
    [rooms] => 1
    [adultshotel] => 1
    ...
    [childrenhotel] => Any
              ...
              <?php
                    ...
                    if(isset($_POST['hotelsearchcrt']) && $_POST['hotelsearchcrt'] != "" && isset($_POST['starth']) && $_POST['starth'] != "")
                    {    
                      
                      $hotelsearchcrt = trim($_POST['hotelsearchcrt']);
                      $rooms = $_POST['rooms'];
                      $adult = $_POST['adultshotel'];
                      $children = $_POST['childrenhotelch'];
                      $childrenhotel = $_POST['childrenhotel'];

                      $startdate = date('Y-m-d',strtotime($_POST['starth']));
                      $enddate = date('Y-m-d',strtotime($_POST['endh']));

                      ?>
                      $scope.hotelsearch = "<?php echo isset($hotelsearchcrt)?$hotelsearchcrt:""; ?>";
                      $scope.rooms = "<?php echo isset($rooms)?$rooms:""; ?>";
                      $scope.adult = "<?php echo isset($adult)?$adult:""; ?>";
                      $scope.children = "<?php echo isset($children)?$children:""; ?>";
                      $scope.childrenhotel = "<?php echo isset($childrenhotel)?$childrenhotel:""; ?>";
                      $scope.startdate = "<?php echo isset($startdate)?$startdate:""; ?>";
                      $scope.enddate = "<?php echo isset($enddate)?$enddate:""; ?>";
                      <?php
...
//return;
                ...
                urltogetFlights = urltogetFlights.replace('start_rest_workflow', 'hotelsearch');

                flightServiceNewHotel.loadDataFromUrls(urltogetFlights,postData).then(function (datanew) {
                    maskedfuncoff();
