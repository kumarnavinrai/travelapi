...
$urltoGetFilghts = "http://localhost:1337/";
...
trk=nav_responsive_tab_profile"></a>
        ...
        <script type="text/javascript">
          ...
          app.controller('filghtCtrl', ['$scope', '$log', 'getFlightDataService', function($scope, $log, getFlightDataService)  { 
              $scope.origin = "<?php print_r($_POST['start']); ?>";
              $scope.destination = "<?php print_r($_POST['start']); ?>";
              $scope.departureDate = "<?php print_r($_POST['start']); ?>";
              $scope.lengthofstay = 5; //"<?php print_r($_POST['start']); ?>";
