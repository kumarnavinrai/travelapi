      ...
      <ul class="nav navbar-nav">
          ...
          <ul class="dropdown-menu mega-dropdown-menu row">
            ...
            <li class="col-sm-2">
              <ul>
                ...
                <li><a href="<?php echo $urlofwp; ?>destination-taipei-taiwan">Taipei</a></li>
				<li><a href="<?php echo $urlofwp; ?>destination-hangzhou">Hangzhou</a></li>
       ...
       <li class="col-sm-2">
              <ul>
                ...
                <li><a href="<?php echo $urlofwp; ?>destination-adelaide">Adelaide</a></li>
                <li><a href="<?php echo $urlofwp; ?>destination-sydney">Sydney</a></li>
				<li><a href="<?php echo $urlofwp; ?>destination-perth">Perth</a></li>
                <li><a href="<?php echo $urlofwp; ?>destination-brisbane">Brisbane</a></li>
                <li><a href="<?php echo $urlofwp; ?>destination-melbourne">Melbourne</a></li>
				<li><a href="<?php echo $urlofwp; ?>destination-darwin">Darwin</a></li>
                <li><a href="<?php echo $urlofwp; ?>destination-polynesia">Polynesia</a></li>
				<li><a href="<?php echo $urlofwp; ?>destination-canberra">Canberra</a></li>
				...
				<li><a href="<?php echo $urlofwp; ?>destination-hobart">Hobart</a></li>
